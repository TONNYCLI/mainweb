...
class VideosController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages/dashboard/videos', compact('photos'));
    ...
    public function create()
    {
        ...
        return view('pages/dashboard/newvideo', compact('category'));
    ...
    public function edit(string $id)
    {
        ...
        return view('pages/dashboard/editvideos', compact('photo', 'category'));
