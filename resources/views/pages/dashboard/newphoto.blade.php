                ...
                <form class="w-full max-w-lg" action="{{ route("store/photo") }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                      <div class="w-full px-3">
                        ...
                        <textarea name="details" id="details"  class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 h-48" ></textarea>
                        <p class="text-gray-600 text-xs italic">Make it as long and  as you'd like</p>
                      </div>
                    </div>
