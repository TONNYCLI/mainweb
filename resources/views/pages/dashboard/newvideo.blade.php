    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <form class="w-full max-w-lg" action="{{ route("store/photo") }}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                      <div class="w-full px-3">
                        ...
                        <input name="details" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="details">
