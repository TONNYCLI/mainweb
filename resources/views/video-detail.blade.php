...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('catalog/fontawesome/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('catalog/css/templatemo-style.css') }}">
<!--
...
<body>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="{{ asset('catalog/img/hero.jpg') }}">
        ...
        <div class="row tm-mb-90">
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <video autoplay muted loop controls id="tm-video">
                    <source src="{{ asset('catalog/video/hero.mp4') }}" type="video/mp4">
                </video>
            </div>
        ...
        <div class="row mb-3 tm-gallery">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="{{ asset('catalog/img/img-01.jpg') }}" alt="Image" class="img-fluid">
